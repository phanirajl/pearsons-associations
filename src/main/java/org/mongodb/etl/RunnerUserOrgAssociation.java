...
public class RunnerUserOrgAssociation {
    ...
    public static void main(String[] args) {
       ...
       /*
        ...
        new RunnerUserOrgAssociation(args[0], args[1], args[2]).run();
    }

    public RunnerUserOrgAssociation(String mongoUri, String srcNs, String tgtNs) {
